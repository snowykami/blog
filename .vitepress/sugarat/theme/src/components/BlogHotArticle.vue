...
const title = computed(() => hotArticle.value?.title || `${fireSVG}${getTextRef("hotArticle.title")}`)
const nextText = computed(() => hotArticle.value?.nextText || getTextRef("hotArticle.change"))
const pageSize = computed(() => hotArticle.value?.pageSize || 9)
const empty = computed(() => hotArticle.value?.empty ?? getTextRef("hotArticle.nothing"))
